...
class ProductTemplate(models.Model):
    ...
    # //////////////////////////AM
    competitors_line = fields.One2many(comodel_name="competitor.line", inverse_name="product_id", string="", required=False, )
    # //////////////////////////AM
...
class CompetitorLine(models.Model):
    _name = "competitor.line"

    competitor_id = fields.Many2one(comodel_name="competitor", string="Competitor", required=False, )
    price = fields.Float(string="Price",  required=False, )
    entey_date = fields.Datetime(string="Entry Date", required=False,default=fields.Datetime.now() )
